...
export const PAYPAL_LIVE_BASEURL = 'https://api.paypal.com';
export const PAYPAL_LIVE_WEBURL = 'https://www.paypal.com';
export const PAYPAL_MAX_RETRIES = 3;
...
export const ACCESS_CONTROL_TOKEN = 'ACCESS_CONTROL_TOKEN';
export const PAYPAL_ENV_TOKEN = 'PAYPAL_ENV_TOKEN';
