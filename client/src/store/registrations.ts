...
import { CreateRegistrationDto } from '@omc/server/event-registration/dtos/create-registration.dto'
import { CreateVolunteerRegistrationDto } from '@omc/server/event-registration/dtos/create-volunteer-registration.dto'
